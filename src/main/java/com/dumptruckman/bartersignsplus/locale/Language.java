package com.dumptruckman.bartersignsplus.locale;
...
public enum Language {
    ...
    public static void load() throws IOException {
        ...
        File languageFile = new File(BarterSignsPlus.getInstance().getDataFolder(), Config.LANGUAGE_FILE_NAME.getString());
